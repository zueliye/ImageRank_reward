...
df = pd.read_csv(r'E:/img-prompt/pre_train_clean/pre_train_clean_add1.csv',encoding='utf-8')
input_pt=[]
label_pt=[]
...
for i in range(len(df['image_uid'])):
    try:
        ...
        print(i)
        torch.save(input_pt,'input_add1.pt')
        torch.save(label_pt,'label_add1.pt')
